...
export const dailyCheckinsTable = pgTable("daily_checkins", {
  ...
  reflectionFeltGood: text("reflection_felt_good"),
  reflectionFeltOff: text("reflection_felt_off"),
  reflectionGotInWay: text("reflection_got_in_way"),
  reflectionAnythingUnusual: text("reflection_anything_unusual"),
