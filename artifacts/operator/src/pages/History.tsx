import { useListDailyCheckins, useListWeeklyReviews } from "@workspace/api-client-react";
                      ...
                      <AccordionItem value="notes" className="border-b-0 px-6">
                        <AccordionTrigger className="hover:no-underline py-4">
                          <span className="font-medium flex items-center gap-2">
                            <LayoutList className="h-4 w-4" /> Details & Notes
                          </span>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4 text-muted-foreground space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="whitespace-pre-wrap">{checkin.tasksCompleted}</p>
                            </div>
                            <div>
                              <strong className="text-foreground block mb-1">Tasks Missed</strong>
